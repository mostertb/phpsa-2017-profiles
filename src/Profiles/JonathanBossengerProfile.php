...
class JonathanBossengerProfile extends AbstractProfile
{
	...
	{
		return 'Jonathan is a self employed developer, currently focusing on WordPress as a platform and source of income.<br>'.
		       'He lives in Durbanville with his wife and 2 boys. <br>'.
		       'In his spare time you will find him training and teaching the art of Gracie Jiu-Jitsu or playing with whatever piece of software technology he wants to learn this week.';
	}
